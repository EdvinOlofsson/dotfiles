...
override_git_prompt_colors() {
  ...
  GIT_PROMPT_STAGED_START="${Green}["           # the number of staged files/directories
  GIT_PROMPT_STAGED_END="${Green}]"           # the number of staged files/directories
  # GIT_PROMPT_CONFLICTS="${Red}✖ "       # the number of files in conflict
  GIT_PROMPT_CONFLICTS_START="${Red}✖ "       # the number of files in conflict
  # GIT_PROMPT_CHANGED="${Blue}✚ "        # the number of changed files
  GIT_PROMPT_CHANGED_START="${Blue}["        # the number of changed files
  GIT_PROMPT_CHANGED_END="${Blue}]"        # the number of changed files

  # GIT_PROMPT_REMOTE=" "                 # the remote branch name (if any) and the symbols for ahead and behind
  GIT_PROMPT_REMOTE_START=" "                 # the remote branch name (if any) and the symbols for ahead and behind
  # GIT_PROMPT_UNTRACKED="${Cyan}…"       # the number of untracked files/dirs
  GIT_PROMPT_UNTRACKED_START="${Cyan}["       # the number of untracked files/dirs
  GIT_PROMPT_UNTRACKED_END="${Cyan}]"       # the number of untracked files/dirs
  # GIT_PROMPT_STASHED="${BoldBlue}⚑ "    # the number of stashed files/dir
  GIT_PROMPT_STASHED_START="${BoldBlue}⚑ "    # the number of stashed files/dir
