...
call s:h("qfError",     { "fg": s:red, "bg": s:black })
call s:h("qfLineNr",    { "fg": s:aqua, "bg": s:black })
...
call s:h("SyntasticWarningSign",        { "fg": s:lightblack, "bg": s:lightblack })
call s:h("SyntasticErrorSign",          { "fg": s:lightblack, "bg": s:lightblack })
call s:h("SyntasticStyleErrorSign",     { "fg": s:lightblack, "bg": s:lightblack })
call s:h("SyntasticStyleWarningSign",   { "fg": s:lightblack, "bg": s:lightblack })

" gitgutter
" ---------
call s:h("GitGutterAdd",        { "fg": s:green, "bg": s:lightblack })
call s:h("GitGutterChange",     { "fg": s:orange, "bg": s:lightblack })
call s:h("GitGutterDelete",     { "fg": s:red, "bg": s:lightblack })
